...
def geracao_texto(mensagens, max_tokens=1000, temperature=0):
    """
...
if __name__ == "__main__":
    ...
    print("Pergunte algo para o AnswerBot ou digite sair para encerrar")
    mensagens = []
    while True:
        texto = input("User: ")
        if texto.lower() in ["sair"]:
            print("Encerrando o AnswerBot. Até mais! =]")
            break
